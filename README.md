...
уровнем тока.
- txVoltageAdj(spV) код 0x25 Команда регулироаки напряжения без остановки заряда.
- txCurrentAdj(spI) код 0x26 Команда регулироаки тока без остановки заряда.
- txDiscurrentAdj(spD) код 0x27 Команда регулироаки тока без остановки разряда.
